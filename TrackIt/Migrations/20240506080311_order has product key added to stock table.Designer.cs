...
namespace TrackIt.Migrations
{
    ...
    [Migration("20240506080311_order has product key added to stock table")]
    partial class orderhasproductkeyaddedtostocktable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrackIt.Models.StockClass", b =>
                {
                    ...
                    b.Property<int?>("orderhasProduct_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TrackIt.Models.StockClass", b =>
                {
                    ...
                    b.HasOne("TrackIt.Models.OrderhasProducts", "orderhasProducts")
                        .WithMany()
                        .HasForeignKey("orderhasProduct_id");
